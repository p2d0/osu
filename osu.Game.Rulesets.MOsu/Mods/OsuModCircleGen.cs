...
namespace osu.Game.Rulesets.MOsu.Mods
{
    ...
    /// </summary>
    public class OsuModCircleGen : ModRandom, IApplicableToBeatmap, IApplicableToDrawableRuleset<OsuHitObject>
    {

        public override string Name => "CircleGen";
        public override string Acronym => "CIGE";
        public override ModType Type => ModType.Conversion;
        // public override IconUsage? Icon => OsuIcon.ModRandom;
        public override double ScoreMultiplier => 1;
        public override LocalisableString Description => "Streams!";
