...
using osu.Game.Rulesets.MOsu.Edit.Blueprints.HitCircles.Components;
using osu.Game.Rulesets.MOsu.Edit.Blueprints.Sliders.Components;
using osu.Game.Rulesets.MOsu.Objects;
using osu.Game.Screens.Edit;
using osuTK;
using osuTK.Input;

namespace osu.Game.Rulesets.MOsu.Edit.Blueprints.Sliders
{
