...
{
    public partial class ChatLine : CompositeDrawable, IHasPopover, IHasContextMenu
    {
        ...
        public MenuItem[] ContextMenuItems
        {
            get
            {
                ...
                // Heuristic to check if content looks like the JSON export (array)
                ...
                {
                    // Ignore parsing failures; context menu just won't show the item
                }
